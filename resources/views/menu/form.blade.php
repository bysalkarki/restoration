...
@section('content')
    <x-card title="Menu Form" footer="">
        ...
        <x-form.input name="externalUrl" type="url" :value="$menu->externalUrl" :option="['placeholder'=>'menu','required'=>true]" />
...
<x-form.input name="metaKeyphrase" :value="$menu->metaKeyphrase" :option="['placeholder'=>'Write keywords to identify this page. seperated by commas','required'=>true]" />
