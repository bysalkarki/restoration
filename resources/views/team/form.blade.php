...
@section('content')
    <x-card title="team Form" footer="">
        ...
        <x-form.image title="image" :value="$team->image" />
            <x-form.input type="email" :value="$team->email" name="email"
                :option="['placeholder'=>'email']" />
        <x-form.input type="url" :value="$team->facebook" name="facebook"
            :option="['placeholder'=>'facebook']" />
            <x-form.input type="url" :value="$team->twitter" name="twitter"
                :option="['placeholder'=>'twitter']" />
                <x-form.input type="url" :value="$team->instagram" name="instagram"
                    :option="['placeholder'=>'instagram']" />
                    <x-form.input type="text" :value="$team->contact" name="contact"
                        :option="['placeholder'=>'contact']" />
        <x-button-component />
        </form>
    </x-card>
@endsection
